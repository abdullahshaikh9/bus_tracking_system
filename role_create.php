        ...
        <div class="px-8 py-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50 flex justify-between items-center">
            <div>
                <h2 class="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
                    <i class="ph ph-shield-plus text-primary-600"></i>
                    Create New Role
                </h2>
                <p class="text-xs text-gray-500 mt-1">Define a new authority level for system users.</p>
            </div>
        ...
        <form action="process_action.php" method="POST" class="p-8 space-y-6">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" placeholder="e.g. Route Manager" required class="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 transition outline-none">
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    <textarea name="description" rows="4" placeholder="Briefly describe what users with this role can do..." class="w-full p-4 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 transition outline-none resize-none"></textarea>
                </div>
            </div>
