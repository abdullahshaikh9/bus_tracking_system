...
<div class="max-w-2xl mx-auto flex flex-col gap-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xl overflow-hidden">
        <div class="px-8 py-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
            ...
            <p class="text-xs text-gray-500 mt-1">Define the path and timing for university transit operations.</p>
        </div>
        ...
        <form action="process_action.php" method="POST" class="p-8 space-y-6">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="route_name" placeholder="e.g. Latifabad Express" required class="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 transition outline-none">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="start_point" placeholder="e.g. Main Campus" required class="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 transition outline-none">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="end_point" placeholder="e.g. Qasimabad" required class="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 transition outline-none">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="time" name="departure_time" required class="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 transition outline-none">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="distance_km" placeholder="e.g. 15.5" required class="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 transition outline-none">
                    </div>
                </div>
                    ...
                    <div class="relative">
                        ...
                        <select name="driver_id" class="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 transition outline-none appearance-none">
                            ...
                            <?php foreach ($drivers as $d): ?>
                                <option value="<?= $d->id; ?>"><?= htmlspecialchars($d->full_name); ?> (Bus #<?= htmlspecialchars($d->bus_number); ?>)</option>
                            <?php endforeach; ?>
                        </select>
